...
function TeamForm() {
  ...
  return (
    <div className='w-full gap-1.5 space-y-3'>
      <h1 style={{ fontFamily: 'Inter, sans-serif' }} className="text-[#FFFFFF] text-3xl font-bold mx-auto w-fit font-"> Đăng kí đội thi</h1>
      {/* Team Name*/}
      <div className="flex flex-col gap-1.5 mt-0 w-full max-w-md py-0">
        <label htmlFor="teamName" className="text-lg font-bold text-[#F1E6FF]">
          Tên đội thi
        </label>
      ...
      <div className="flex flex-row gap-1.5 mt-0 w-full max-w-md py-0">
        ...
        <div className="flex flex-col gap-1.5 mt-0 w-full max-w-md flex-[7]">
          <label htmlFor="instructorName" className="text-lg font-bold text-[#F1E6FF]">
            Người đại diện 
          </label>
          <Field
            id="instructorName"
        ...
        <div className="flex flex-col gap-1.5 mt-0 w-full max-w-md flex-[3]">
          <label htmlFor="level" className="text-lg font-bold text-[#F1E6FF]">
             Bảng thi
          </label>
          <Field
            as="select"
...
<div className="flex flex-row gap-1.5 mt-0 w-full max-w-md py-0">
      <div className="flex flex-col  gap-1.5 mt-0 w-full max-w-md">
        <label htmlFor="instructorEmail" className="text-lg font-bold text-[#F1E6FF]">
          Email
        </label>
        <Field
          id="instructorEmail"
      ...
      <div className="flex flex-col gap-1.5 mt-0 w-full max-w-md">
        ...
        <label htmlFor="instructorPhone" className="text-lg font-bold text-[#F1E6FF]">
          SĐT
        </label>
        <Field
          id="instructorPhone"
