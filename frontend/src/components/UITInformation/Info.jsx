...
export default function UITInformation() {
  ...
  return (
    <section className="w-full px-6 md:px-20 h-screen py-12 md:py-24 lg:py-32 xl:py-30 relative overflow-hidden text-white">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative rounded-2xl shadow-xl border border-blue-500 glow-animation">
          <div className="absolute top-2 right-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-3 py-1 text-sm rounded-full flex items-center gap-1">
            <MapPin size={16} />
            UIT Location
          </div>
          <iframe
        ...
        <div className="relative space-y-4">
                            <h2 className="text-2xl font-bold tracking-tighter sm:text-5xl xl:text-5xl/none bg-gradient-to-r from-white to-zinc-300 text-transparent bg-clip-text">
